...
},
{
  ...
  config = function()
    ...
    if use_mason then
      ...
      -- Print helpful message for NixOS users on first setup
      vim.schedule(function()
        vim.notify(
          "NixOS detected - LSPs managed via Nix configuration\n" ..
          "Install via: environment.systemPackages = [ pkgs.lua-language-server ];",
          vim.log.levels.INFO,
